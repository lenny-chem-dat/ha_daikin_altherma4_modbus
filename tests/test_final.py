...
def test_syntax_validity():
    ...
    project_root = Path(__file__).parent.parent
    python_files = list(project_root.glob("custom_components/ha_daikin_altherma4_modbus/*.py"))
...
def test_mock_client_fix():
    ...
    project_root = Path(__file__).parent.parent
    mock_client_file = project_root / "custom_components" / "ha_daikin_altherma4_modbus" / "mock_client.py"
    ...
    assert fix_pattern in content, "Mock client simplified discrete input logic is missing"
