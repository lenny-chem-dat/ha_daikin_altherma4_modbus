...
client_interface_module = load_module('client_interface', custom_components_path / "client_interface.py")
mock_client_module = load_module('mock_client', custom_components_path / "mock_client.py")
...
class TestIntegration:
    ...
    def test_full_workflow(self, mock_client):
        ...
        demo_data = mock_client_module.MockModbusTcpClient._generate_demo_register_data()
        assert isinstance(demo_data, dict)
