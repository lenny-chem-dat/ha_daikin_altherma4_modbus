...
try:
    ...
    from ha_daikin_altherma4_modbus.mock_client import MockModbusTcpClient, MockModbusResponse
    ...
    source = source.replace('from .client_interface', 'from ha_daikin_altherma4_modbus.client_interface')
    ...
    # Load const
    const_spec = importlib.util.spec_from_file_location('ha_daikin_altherma4_modbus.const', custom_components_path / "const.py")
...
class TestMockClientClean:
    ...
    def test_demo_data_generation(self, demo_data):
        ...
        required_keys = ['input_registers', 'holding_registers', 'discrete_inputs', 'coils']
